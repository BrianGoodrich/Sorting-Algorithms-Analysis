...
//Written by Brian Goodrich. The purpose of this program is to provide run times for the optimized Bubble Sort algorithm that "counts swaps".
...
public class BubbleSortWithSwaps {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The execution times of bubble sort with swaps counting on an array of random integers 1 - 10,000: \nArray size 1,000: " + executionTime1 + " nanoseconds\nArray size 10,000: " + executionTime2 + " nanoseconds\nArray size 100,000: " + executionTime3 + " nanoseconds");

        sortedArray1k = bubbleSortSwapsCounting(array1k);
        sortedArray10k = bubbleSortSwapsCounting(array10k);
        sortedArray100k = bubbleSortSwapsCounting(array100k);

        executionTime1 = runTime(sortedArray1k);
        executionTime2 = runTime(sortedArray10k);
        executionTime3 = runTime(sortedArray100k);

        System.out.println("The execution times of bubble sort with swaps counting on an array of sorted random integers 1 - 10,000: \nArray size 1,000: " + executionTime1 + " nanoseconds\nArray size 10,000: " + executionTime2 + " nanoseconds\nArray size 100,000: " + executionTime3 + " nanoseconds");
        ...
        System.out.println("The execution times of bubble sort with swaps counting on an array of partially sorted random integers 1 - 10,000 where every 10th integer is randomized: \n Array size 1,000: " + executionTime1 + " nanoseconds\nArray size 10,000: " + executionTime2 + " nanoseconds\nArray size 100,000: " + executionTime3 + " nanoseconds");

    }

    //Citation: (2022) Bubble Sort [Source Code] https://www.geeksforgeeks.org/bubble-sort/
    //This bubble sort algorithm was taken from the source above, with some modifications to implement "swap counting".
    public static int [] bubbleSortSwapsCounting(int[] arr) {
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            if (swapped == false) //if no two elements were swapped in the inner loop then break the loop because no more swaps are necessary.
                break;
        }
        return arr;
    }
